...
def import_gtfs(options, gtfsZip):
    ...
    print(type(options.modes))
    print(options.modes)
    # As `options.modes` is a string, we need to address difference between 
    # mode type string "trolleybus" and "bus" (which would match trolleybus as well),
    # therefore we will split the comma/separated `options.modes` string into 
    # a tuple of strings denoting particular modes.
